...
const OnlineMeetings = () => {
    return ( 
        <div className="Online-meeting">
            ...
            <Navbar />
            <div className="Online-meeting">
                <div className="online-meeting_banner">
                ...
                <JoinWork />
                <div className="online-meeting_events">
                    <div className="upcoming">
                        <h2>Next Online  Meeting</h2>
                        <div className="upcoming_event one">
                            <h2 className="meeting"><FaCalendar className="icons" /> Febuary Online Meeting</h2>
                            <h2>Date: <span>Febuary 23, 2024</span></h2>
                            <p className="time"><FaClock className="icons" /> 4:00pm</p>
                        </div>
                    </div>
                    <h2 className="past_event-text">Past Online Meeting</h2>
                    <div className="past">
